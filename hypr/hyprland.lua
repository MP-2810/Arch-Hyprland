...
hl.on("hyprland.start", function ()
  ...
  hl.exec_cmd("mako & waybar & blueman-applet & nm-applet & copyq")
  hl.exec_cmd("fcitx5 & v2rayN")
...
hl.bind(mainMod .. " + ALT + W", hl.dsp.exec_cmd("waypaper"))
...
hl.bind(mainMod .. " + ALT + F", hl.dsp.window.fullscreen_state({
...
hl.bind("ALT + W", hl.dsp.exec_cmd(terminal))
